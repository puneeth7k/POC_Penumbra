...
public class TestListener extends DriverUtil implements ITestListener {
    ...
    public void onTestFailure(ITestResult iTestResult) {
        ...
        //Update the test result on excel sheet
        ex.setCellData("FAILED", ex.getRowNumber(), ex.getColumnNumber());
        System.out.println("chekc failed");
    }
    ...
    public void onTestSkipped(ITestResult iTestResult) {
        ...
        //Update the test result on excel sheet
        ex.setCellData("SKIPPED", ex.getRowNumber(), ex.getColumnNumber());
    }
