...
public class NavigateMethods extends SelectElementByType implements BaseTest
{
	 ...
	 * @return 
	 */
	public int counthOverElement(String accessType, String accessName)
	{
	 ...
	 */
	public void scrollToElement(String accessType, String accessName) throws InterruptedException
	{
		element = wait.until(ExpectedConditions.presenceOfElementLocated(getelementbytype(accessType, accessName)));
