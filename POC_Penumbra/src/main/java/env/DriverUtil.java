...
public class DriverUtil {
	public static long DEFAULT_WAIT = 40;
    public static WebDriver driver;
    public WebDriverWait wait;
    //Global test data excel file
    public static final String testDataExcelFileName = "15232-1.xlsx";
...
*/
    ...
    public static WebDriver getDefaultDriver() {
        ...
        System.setProperty("webdriver.chrome.driver","C:/Driver-Firefox/chromedriver_win32/chromedriver.exe");
        //System.setProperty("webdriver.gecko.driver", "C:/Driver-Firefox/geckodriver-v0.24.0-win32/geckodriver.exe");
